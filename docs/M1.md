...
任务卡的完整 7 字段（前置 / 产出 / 算法核心 / L0 测试 / DoD / 坑 / 估时）已迁移到 `docs/tasks/M1-TX-*.md`，每张卡一个独立文件，便于版本化、精准 review、AI 协作。

- 索引: [docs/tasks/README.md](./tasks/README.md)
- 模板: [docs/tasks/_TEMPLATE.md](./tasks/_TEMPLATE.md)
- 新建任务卡: `cp docs/tasks/_TEMPLATE.md docs/tasks/M1-TX-name.md`，或运行 `/next-task` slash 命令自动生成
...
| 9 | 国内下不动 HF | Connection reset | 已默认走 ModelScope（见 SETUP §5.4） |
...
> 见旧 M1.md §9（已搬运到 docs/CONCEPTS.md，避免本文件过长）。
> 当前文件以"任务拆解 + 架构"为主，概念查 docs/CONCEPTS.md。

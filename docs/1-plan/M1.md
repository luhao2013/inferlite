...
QwenLM/Qwen3、llama.cpp、SGLang、TGI、TensorRT-LLM 统一记录在 `docs/3-kb/REFERENCES.md`；M1 只按上表读取，不泛读。

## 4. 任务卡总表（M1·P1）

> **每张卡的完整 7 字段（前置/产出/算法核心/L0测试/DoD/坑/估时）** 在 `docs/2-tasks/M1-TX-*.md` 独立文件中维护。
> 这里只列索引与状态。索引文件：[docs/2-tasks/README.md](../2-tasks/README.md)。
> **`[P]` 列**：标 ✓ 表示与同前置的其他任务可并行开工（开两个分支或两个会话同时推）。

| # | 名称 | 状态 | 前置 | [P] | 任务卡详情 | 估时 |
| --- | --- | --- | --- | --- | --- | --- |
| **T0** | **ModelConfig dataclass** | **✅** | — | — | [M1-T0-ModelConfig.md](../2-tasks/M1-T0-ModelConfig.md) | 已完成 |
| **T1** | **RMSNorm** | **✅** | T0 | ✓ | [M1-T1-RMSNorm.md](../2-tasks/M1-T1-RMSNorm.md) | 已完成 |
| **T2** | **SwiGLU MLP** | **✅** | T0 | ✓ | [M1-T2-SwiGLU.md](../2-tasks/M1-T2-SwiGLU.md) | 已完成 |
| T3 | RoPE | ✅ | T0 | ✓ | [M1-T3-RoPE.md](../2-tasks/M1-T3-RoPE.md) | 已完成 |
| T4 | GQA Attention | ✅ | T1, T3 | — | [M1-T4-GQA-Attention.md](../2-tasks/M1-T4-GQA-Attention.md) | 已完成 |
| T5 | DecoderLayer | ✅ | T1, T2, T4 | — | [M1-T5-DecoderLayer.md](../2-tasks/M1-T5-DecoderLayer.md) | 已完成 |
| T6 | Qwen3Model | ✅ | T1, T5 | — | [M1-T6-Qwen3Model.md](../2-tasks/M1-T6-Qwen3Model.md) | 已完成 |
| T7 | WeightMap + load_from_hf | ✅ | T6 | — | [M1-T7-WeightMap-load-from-hf.md](../2-tasks/M1-T7-WeightMap-load-from-hf.md) | 已完成 |
| **T8** | **L1 logits 对齐** | ✅ | T7 | — | [M1-T8-L1-logits-alignment.md](../2-tasks/M1-T8-L1-logits-alignment.md) | 已完成 |
...
| # | 名称 | 状态 | 前置 | [P] | 任务卡详情 | 估时 |
| --- | --- | --- | --- | --- | --- | --- |
| T9 | LLMModel Protocol + GreedySampler | ✅ | T8 | — | [M1-T9-LLMModel-GreedySampler.md](../2-tasks/M1-T9-LLMModel-GreedySampler.md) | 已完成 |
| T10 | EngineCore.step() 三段式 | ✅ | T9 | — | [M1-T10-EngineCore-step.md](../2-tasks/M1-T10-EngineCore-step.md) | 已完成 |
| T11 | CLI + L2 e2e | ✅ | T10 | — | [M1-T11-CLI-L2-e2e.md](../2-tasks/M1-T11-CLI-L2-e2e.md) | 已完成 |
| T12-pre | Last-token logits optimization | 🟡 | T11 | — | [M1-T12-pre-last-token-logits.md](../2-tasks/M1-T12-pre-last-token-logits.md) | 1h |
...
参考卡片：[`knowledge.md` → `vLLM — Qwen3 weight loading`](../3-kb/knowledge.md#vllm-qwen3-weight-loading)。
...
> 概念（形状/超参/upcast/tie_embed 等）见 `docs/3-kb/knowledge.md` → Concepts。
> 库 API（transformers/pytest/uv 等）见 `docs/3-kb/knowledge.md` → Libraries。
> 论文（RMSNorm/SwiGLU/RoPE/GQA）见 `docs/3-kb/knowledge.md` → Papers。

## 12. 参考项目与论文

> 见 [docs/3-kb/REFERENCES.md](../3-kb/REFERENCES.md) — 三梯队开源项目（nano-vllm / LLMs-from-scratch / transformers / vllm / ...）+ 论文清单 + 阶段-资料对照表。

...
| T3 | RoPE | 🟡 | T0 | ✓ | [M1-T3-RoPE.md](../2-tasks/M1-T3-RoPE.md) | 2h |
| T4 | GQA Attention | 🟡 | T1, T3 | — | [M1-T4-GQA-Attention.md](../2-tasks/M1-T4-GQA-Attention.md) | 3h |
| T5 | DecoderLayer | ⬜ | T1, T2, T4 | — | 开工时创建 | 1h |
| T6 | Qwen3Model | ⬜ | T1, T5 | — | 开工时创建 | 2h |

...
| T7 | WeightMap + load_from_hf | 🟡 | T6 | — | [M1-T7-WeightMap-load-from-hf.md](../2-tasks/M1-T7-WeightMap-load-from-hf.md) | 3h |
| **T8** | **L1 logits 对齐** | ⬜ | T7 | — | 开工时创建 | 2h |
...
| # | 名称 | 状态 | 前置 | [P] | 任务卡详情 | 估时 |
| --- | --- | --- | --- | --- | --- | --- |
| T9 | LLMModel Protocol + GreedySampler | ⬜ | T8 | — | 开工时创建 | 1h |
